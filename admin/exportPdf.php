...
require_once('../assets/TCPDF-main/tcpdf_import.php');
...
$pdf->MultiCell(0, 10, 'ALCALDIA DE GUAYABETAL', 0, 'C', 0, 0, '', 90, true);
...
$pdf->SetFont('dejavusans', '', 10, '', true);
$pdf->MultiCell(0, 10, 'YOANA MORENO HUERFANO', 0, 'C', 0, 0, '', 206, true);
$pdf->MultiCell(0, 10, 'SECRETARIA DE PLANEACION Y OBRAS PUBLICAS', 0, 'C', 0, 0, '', 210, true);
