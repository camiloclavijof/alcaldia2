           ...
           <div class="row">
               <div class="container filas">
                  <div class="col-md-12 btn btn-md">
                        ...
                        <form action="/pruebasu/admin/exportExcel.php" method="post">
                       ...
                       <table id="tabla" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="col-xs-1">Generar Certificado</th>
                            ...
                            while($row = mysqli_fetch_assoc($run)){
                              echo '
                                 <tr>
                                    ...
                                    <td class="col-xs-1">'.$row['numero_documento1'].'</td>
                                    <td class="col-xs-1">'.$row['nombre'].'</td>
                                    <td class="col-xs-1">'.$row['apellido1'].'</td>
                                    <td class="col-xs-1">'.$row['apellido2'].'</td>
                                    <td class="col-xs-1 cert"> <a href="../admin/exportPdf.php?id='.$row['id_datospersonales'].'" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></td>
