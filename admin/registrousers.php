       ...
       <div class="container">
           <div class="row">
               <div class="form">
                   ...
                   <h3>Registro y Actualización de Usuario</h3>
                   </br></br>
                   <form action="" method="post">
                        ...
                        <button type="submit" name="registrar" class="btn btn btn-warning enviar btn-block">Registarse</button>
                                          

                   </form>
               <a href="admin.php">&laquo; Regresar &laquo;</a>
               </div>
