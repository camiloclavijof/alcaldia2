    ...
    if(!empty($_POST['UserEmail']) && !empty($_POST['UserPass'])){
        ...
        if($result = mysqli_query($conn, $sql)){
            while($rows = mysqli_fetch_assoc($result)){
                ...
                if($rows['UserPass'] != $post_UserPass){
                    header('Location: index.php?login_error=pass_null');
                    return false;
                }
                if(mysqli_num_rows($result) == 1){
                   ...
                   //acceso administrador
                    ...
                    //acceso usuario con permiso de consultar
                //     if($rows['role'] == 'usu1'){
            //           echo $rows['role'];
              //           header('Location: usu1/index.php');
                //   } else {
                 //        header('Location: usu1/index.php');
                   //  }
				 	//acceso usuario con permisos de registrar y de editar
                    // if($rows['role'] == 'usu2'){
                      //   echo $rows['role'];
                     //    header('Location: usu2/index.php');
                    // } else {
                   //      header('Location: usu2/index.php');
                  //   }
				// 	//acceso aseguradora3
        ...
        <div class="container">
            <div class="row">
                <div class="main">                          
                  ...
                  <img src="assets/img/logo1,3.jpg">
                    </div>
                    <div class="form-group">
                      <label for="UserEmail">Usuario:</label>
                      <input type="email" class="form-control"  id="UserEmail" placeholder="Escriba su Correo" name="UserEmail" required>
                    </div>
                    <div class="form-group">                      
